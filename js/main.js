...
function renderData(array, parent) {
    ...
    array.forEach((element) => {
        ...
        <div class="card-body">
            ...
            <p class="card-text">Rating: ${element.rating.rate}  <button class="btn-korzinka"><svg data-v-b3e9397c="" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="ui-icon  add-cart-icon">
            ...
            <button class="btn-sara"><svg data-v-b3e9397c="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" alt="like" class="ui-icon ">
...
elSearchBtn.addEventListener("click", evt => {
    ...
    data.forEach((data) => {
        ...
        if (data.title.toLowerCase().includes(elSearchInput.value.toLowerCase())) {
            newArray.push(data)
